...
*/
  ...
  public void runScript(String test, String extraArgs) {
    ...
    sh.exec("rm -f ${l}/actual");
    println "***SN: Remove any preivous run output"
    println sh.out
    println "***SN: any err? "
    println sh.err
    ...
    cat ${l}/actual
    mkdir -p ${runDir}/nativeHiveOutputs
    rm -rf ${runDir}/nativeHiveOutputs/${test}
    mkdir -p ${runDir}/nativeHiveOutputs/${test}
    cp  ${l}/actual ${runDir}/nativeHiveOutputs/${test}/actual
    """);
