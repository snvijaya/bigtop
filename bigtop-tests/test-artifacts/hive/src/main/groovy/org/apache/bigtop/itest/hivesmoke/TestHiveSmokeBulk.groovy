...
public class TestHiveSmokeBulk {
  ...
  public TestHiveSmokeBulk(String t) {
    test = t;
    println("TestHiveSmokeBulk constructor " + t);
  }
  ...
  public static void setUp() {
    sh.exec("sudo rm -rf /var/lib/hive/metastore/metastore_db/*.lck");
    println("setUp start");
    def seedHqlPath = TestHiveSmokeBulk.class.getResource('/seed.hql').getPath()
    println "seedHqlPath " + seedHqlPath
    def testDirPath = new File(seedHqlPath).getParent()
//    def testDirPath = TestHiveSmokeBulk.class.getResource('/').getPath()
    println "testDirPath " + testDirPath
//    def scriptDir = getClass().protectionDomain.codeSource.location.path
//    println "scriptDir " + scriptDir
    def runDir = System.getProperty("user.dir");
    println "runDir " + runDir

    def command = "cd ${testDirPath};hive -f " + seedHqlPath;
    println command
