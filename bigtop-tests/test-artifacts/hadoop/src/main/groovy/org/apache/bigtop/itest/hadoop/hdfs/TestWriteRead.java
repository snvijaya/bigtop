...
//  private FileContext mfc; // = FileContext.getFileContext();
	...
	private FileSystem mfs; // = FileSystem.get(conf);
	private FileContext mfc;// = FileContext.getFileContext();
...
//    }
  ...
  private long readData(String fname, byte[] buffer, long byteExpected, long beginPosition)
    ...
    try {
      ...
      long visibleLenFromReadStream = byteExpected; 
	
      System.out.println("***SN: visibleLenFromReadStream = " + visibleLenFromReadStream);
      System.out.println("***SN: byteExpected = " + byteExpected);
      System.out.println("***SN: beginPosition = " + beginPosition);
...
*/
      ...
      in.close();
      System.out.println("***SN: totalByteRead = " + totalByteRead);
