...
//      FileSystem fs2 = (FileSystem) FileSystem.newInstance(fs.getUri(), fs.getConf());
//
...
//
//    Mockito.doReturn(
//        newFileStatus(0, false, 1, 1024, 0, 0, new FsPermission(
//            (short) 777), "owner", "group", new byte[0], new byte[0],
//            1010, 0, null, (byte) 0, null)).fs.getFileStatus(new Path(anyString()));
//    Mockito
//        .doReturn(
//            newFileStatus(0, false, 1, 1024, 0, 0, new FsPermission(
//                (short) 777), "owner", "group", new byte[0], new byte[0],
...
//  FileSystem fs = FileSystem(new Configuration());
