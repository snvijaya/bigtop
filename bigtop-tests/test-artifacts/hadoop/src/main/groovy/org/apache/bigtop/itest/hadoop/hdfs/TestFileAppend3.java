...
//          EnumSet.of(CreateFlag.APPEND, CreateFlag.NEW_BLOCK), 4096, null);
        FSDataOutputStream out = fs.append(p, 4096, null);
      AppendTestUtil.write(out, len1, len2);
      out.close();
    }
...
/*      LocatedBlocks blks = fs.dfs.getLocatedBlocks(p.toString(), 0);
      ...
      AppendTestUtil.check((FileSystem)fs, p, 0, len1);
      AppendTestUtil.check((FileSystem)fs, p, len1, len2);
*/
    }
  }

  @Test
  public void testTC12ForAppend2False() throws Exception {
    testTC12(false);
  }
...
//        fs.append(p);
  ...
  // Do small appends.
  void doSmallAppends(Path file, FileSystem fs, int iterations)
    throws IOException {
